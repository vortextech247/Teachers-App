...
# ==========================================
MASTER_SHEET_NAME = "Teachers_Master_DB"  # نفس الاسم اللي سميت بيه الشيت الماستر
ADMIN_USERNAME = "admin"                  # يوزر نيم عشان تدخل انت لوحة التحكم
ADMIN_PASSWORD = "admin"                  # باسورد ليك انت
